  ...
  <header>
    ...
    <main class="page-container">
      <section class="form-container">
        ...
        <form class="book-form" id="formTambahBuku" method="POST" enctype="multipart/form-data">
          ...
          <div class="button-container">
            <a href="manajemenBuku.php"><button type="submit" class="submit-button">Upload</button></a>
          </div>
        </form>
      </section>
    </main>
    <script src="../assets/js/hamburger.js"></script>
    <script src="../assets/js/tambahBukuBaru_ajax.js"></script>
  </body>
</html>
